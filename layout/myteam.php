...
/**
 * Theme Learnbook - myteam layout file
 *
...
$centerhtml = $OUTPUT->blocks('center');
...
echo $OUTPUT->render_from_template('theme_learnbook/myteam', $templatecontext);